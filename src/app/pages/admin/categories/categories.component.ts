...
import { Category, CategoryRequest, MattressCategory } from '../../../core/models/category.model';
...
export class AdminCategoriesComponent implements OnInit {
  ...
  readonly categoryTypes: MattressCategory[] = ['MEMORY_FOAM', 'SPRING', 'LATEX', 'HYBRID', 'ORTHOPEDIC', 'ORGANIC', 'KIDS', 'OTHER'];
  ...
  emptyForm(): CategoryRequest {
    return { name: '', description: '', imageUrl: '', categoryType: 'OTHER', active: true };
  }
